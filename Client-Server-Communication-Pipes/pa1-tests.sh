...
echo -e "\nTesting :: ./client -p 9 -s 4; diff -sqwB <(head -n 2000 BIMDC/9.csv|tail -n 1000) received/x1.csv\n"
./client -p 9 -s 4 >/dev/null 2>&1
if test -f "received/x1.csv"; then
    if diff -wB <(head -n 2000 BIMDC/9.csv|tail -n 1000) received/x1.csv >/dev/null; then
...
##Multiple datapoint test (1)
echo -e "\nTesting :: ./client -p 5 -s 4; diff -sqwB <(head -n 2000 BIMDC/5.csv|tail -n 1000) received/x1.csv\n"
./client -p 5 -s 4 >/dev/null 2>&1
if test -f "received/x1.csv"; then
    if diff -wB <(head -n 2000 BIMDC/5.csv|tail -n 1000) received/x1.csv >/dev/null; then
